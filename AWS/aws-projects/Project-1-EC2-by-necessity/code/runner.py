"""
IMPORTANT NOTE -
This code exists solely to enforce a workload contract for the project "EC2 by Necessity — Compute Selection Case Study".
...
# =========================
DEFAULT_RUNTIME_SECONDS = 10 * 60  # 10 minutes default
